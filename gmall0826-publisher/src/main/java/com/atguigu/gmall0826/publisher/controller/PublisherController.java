...
public class PublisherController {
    @Autowired
    PublisherService publisherService;//有其实现类,在service里面的PublisherServiceImpl
    ...
    public String  getRealtimeTotal(@RequestParam("date") String date ){
        ...
        Long dauTotal = publisherService.getDauTotal(date);//publisherService这是个接口,没有new,靠上面注入的
